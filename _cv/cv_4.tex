...
%for the sensitivity of Debye shielding response and sheath edge formation.
%\item Developed a Fortran-based 2D finite-volume Vlasov solver for validation of the new sensitivity algorithm.
% \item Multi-point penalty-based optimization framework for chaotic turbulent flows
...
%and demonstrated sensitivity degradation due to chaotic particle dynamics.
%\item Participated in a 4-month student internship at Sandia National Laboratories for collaboration.
% \item Novel regular gradient computing method for chaotic plasma particle kinetics
%Published a peer-reviewed journal paper.
...
W.\ Anderson, \textbf{S.\ W.\ Chung}, R.\ Stephany \& Y.\ Choi,
``mLaSDI: Multi-stage latent space dynamics identification,'' 
\textit{Computer Methods in Applied Mechanics and Engineering}, 461, Part B, (2026) 119173.
\par
Y.\ Choi \textit{et al.} (\textbf{S.\ W.\ Chung})
``Rigor Over Hype: What Foundation Model Should Mean in Computational Science''
\textit{Computing in Science and Engineering}, 01, (2026).
\par
...
\textit{Journal of Computational Physics}, (2026) 114978.
\par
\textbf{S. W. Chung}, S.\ Castonguay, S.\ Roy, M.\ Penwarden, Y.\ Fu and P.\ Roy,
``Hard-constrained Physics-informed Neural Networks for Interface Problems''
\textit{arXiv preprint}, arXiv:2604.08453, (2026).
\par
\textbf{S. W. Chung}, S.\ W.\ Cheung, Y.\ Choi, P.\ Roy, T.\ Roy, T.\ Lin, D.\ T.\ Nguyen, C.\ Hahn, E.\ B.\ Duoss \& S.\ E.\ Baker
``A Scalable Reduced-Order Model for the Steady Navier-Stokes Equations,''
\textit{International Journal for Numerical Methods in Engineering}, 127, no. 7 (2026) e70314.
\par
\textbf{S.\ W.\ Chung}, C.\ Miller, Y.\ Choi, H.\ K.\ Springer \& K.\ Sullivan,
``Latent Space Element Method,''
\textit{arXiv preprint}, arXiv:2601.01741, (2026).
\par
...
\textit{Computer Physics Communications} (2026) 110039.
\par
S. W. Cheung, Y. Choi, \textbf{S. W. Chung}, J.-L. Fattebert, C. Kendrick, \& D. Osei-Kuffuor,
``Theory and numerics of subspace approximation of eigenvalue problems,''
\textit{Applied Mathematics and Computation}, 511, (2026) 129722.
\par
...
\textbf{S.\ W.\ Chung}, ``Overview of data-driven finite element method and its pathway toward foundation model in computational science,''
\textit{Interdisciplinary Scientific Computing Laboratory Seminar}, Pennsylvania State University, (2025).
\par
\textbf{S.\ W.\ Chung}, ``Data-driven discontinuous Galerkin FEM via Reduced Order Modeling and Domain Decomposition,''
\textit{FEM@LLNL Seminar}, Lawrence Livermore National Laboratory, (2024).
\par
J.\ B.\ Freund \& \textbf{S.\ W.\ Chung}, ``Sensitivity and Optimization within simulations of chaotic flow system,''
Lawrence Livermore National Laboratory, (2021).
\par
\textbf{S.\ W.\ Chung}, ``Sensitivity Calculation and Gradient-based Optimization for Chaotic Dynamical Systems,''
\textit{Fluid Mechanics Seminar}, University of Illinois at Urbana-Champaign, (2020).
\par
\textbf{S.\ W.\ Chung}, ``Sensitivity Analysis in Particle-in-cell methods,'' Sandia National Laboratories, (2017).
\end{rSection}

%----------------------------------------------------------------------------------------
%\vspace*{-30pt}
\begin{rSection}{Conference Talks}
\textbf{S.\ W.\ Chung}, P.\ Roy, S.\ T.\ Castonguay, Y.\ Fu, M.\ Penwarden,    
``Beyond Soft Penalties: Hard-Constrained Neural Methods for Accurate Solution of Elliptic Interface,"
\textit{17th World Congress on Computational Mechanics and 10th European Congress on Computational Mechanics in Applied Sciences and Engineering} (2026).
\par    
\textbf{S.\ W.\ Chung}, Y.\ Choi, C.\ Miller, H.\ K.\ Springer \& K.\ Sullivan,    
``Non-Intrusive, Scalable Modeling of Physical Systems via Latent Space Element Method,"
\textit{Joint Mathematics Meetings} (2026).
\par
...
``Scalable physics-guided data-driven component model reduction for steady Navier-Stokes flow,"
\textit{NeurIPS 2024 Workshop on the Machine Learning and the Physical Sciences} (2024).
\par
I.\ Zanardi, A.\ N.\ Diaz, S.\ W.\ Chung, M.\ Panesi, \& Y.\ Choi,
``Scalable nonlinear manifold reduced order model for dynamical systems,''
\textit{NeurIPS 2024 Workshop on the Machine Learning and the Physical Sciences} (2024).
...
International Journal of Digital Earth (2026-present)\\
APL Machine Learning (2026-present)\\
%\par
\end{rSection}
