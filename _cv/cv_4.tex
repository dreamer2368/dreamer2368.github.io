...
\address{Postdoctoral Researcher \\ Material Engineering Division \\ Lawrence Livermore National Laboratory}
\address{(+1)~217~417~1921 \\ \href{mailto:chung28@llnl.gov}{chung28@llnl.gov} \\ \href{https://www.chung-research.com}{chung-research.com} \\ \href{https://www.linkedin.com/in/kevin-seung-whan-chung}{linkedin}} % Your phone number and email
%\address{https://-}
...
\item Advised and mentored two summer student interns (Ping-Hsuan Tsai, Seung-Won Suh)
\end{rSubsection}
...
\textit{NeurIPS 2023 Workshop on the Machine Learning and the Physical Sciences}, submitted, (2023).
\par
...
{ }{\em Available upon request}
\item A scalable reduced order model for linear PDE systems with discontinuous Galerkin domain decomposition,
implemented upon \href{https://mfem.org}{\texttt{MFEM}} and \href{https://www.librom.net}{\texttt{libROM}} framework
\item Developed and demonstrated the framework for Poisson and Stokes flow equation
\end{rSubsection}
