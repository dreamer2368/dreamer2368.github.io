...
%for the sensitivity of Debye shielding response and sheath edge formation.
%\item Developed a Fortran-based 2D finite-volume Vlasov solver for validation of the new sensitivity algorithm.
\item Identified uncertainties in electron-argon collision cross sections via Bayesian inference
\item Orchestrated system modeling and large-scale numerical simulations to predict inductively-coupled argon plasma torch
\end{rSubsection}
